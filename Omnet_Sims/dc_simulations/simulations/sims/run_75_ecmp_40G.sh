...
bash ./dir_creator.sh
mkdir -p results/ecmp
mkdir -p logs/ecmp

OPP_LOG=logs/ecmp/opp_runall.log

echo "\n\n-------------------------------------------"
echo "Running ECMP (75% load collection config)"
