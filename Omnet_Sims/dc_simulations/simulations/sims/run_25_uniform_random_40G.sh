...
opp_runall -j50 ../../src/dc_simulations -m -u Cmdenv -c UNIFORM_RANDOM -n ..:../../src:../../../inet/src:../../../inet/examples:../../../inet/tutorials:../../../inet/showcases --image-path=../../../inet/images -l ../../../inet/src/INET omnetpp_25_bg_dqps_collection.ini --sim-time-limit=$SIMULATION_TIME
