...
#sudo mkdir extracted_results/QUEUEING_TIME di vert
...
#sudo mkdir extracted_results/FIN_ACK_RCV di vert
...
#sudo mkdir extracted_results/IP_DATA_PACKET_SENT_COUNTER di vert
...
#sudo mkdir extra#sudo mkdir extracted_results/RTTcted_results/LIGHT_RTT_SUMS
...
#sudo mkdir extracted_results/LIGHT_GOODPUT_NUM_BITS_SENT_TO_APP di vert
